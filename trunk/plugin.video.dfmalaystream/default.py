...
def Dfm2uMenu():
        ...
        addon.add_directory({'mode': 'GetTitles', 'section': 'ALL', 'url': BASE_URL + '/dfm2u/telemovie/',
                             'startPage': '1', 'numOfPages': '1'}, {'title':  'DFM2U Telemovies'}, img=IconPath + 'dfm2uico.png', fanart=FanartPath + 'fanart.png')
        ...
        addon.add_directory({'mode': 'GetEpisode', 'section': 'ALL', 'url': BASE_URL + '/dfm2u/tvshow/',
                             'startPage': '1', 'numOfPages': '1'}, {'title':  'DFM2U TV Shows'}, img=IconPath + 'dfm2uico.png', fanart=FanartPath + 'fanart.png')                                          
        xbmcplugin.endOfDirectory(int(sys.argv[1]))
